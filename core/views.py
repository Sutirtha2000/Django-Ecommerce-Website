...
def itemDetail(request, slug=None):
        ...
        try:
            ...
            if form.is_valid():
                ...
                if same_billing_address:
                    print('using the same billing address')
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect('core:payment', kwargs={
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.info(request, "Your Refund request was submitted !!!")
